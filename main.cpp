...
int main(){
    ...
    unsigned char message[] = "This is a meeessage we will encrypt with AES!";
    ...
    unsigned char* paddedMessage = (unsigned char*)malloc(sizeof(unsigned char) * lengthOfPaddedMessage);//new unsigned char[lengthOfPaddedMessage];
...
void AES_decrypt(unsigned char* cipher, unsigned char* key){
    ...
    // Output the decrypted state to the cipher array
    for (int i = 0; i < 16; i++) {
        cipher[i] = state[i];
    }
}
