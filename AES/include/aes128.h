...
//Struct containging the necessary data for the encryption and the decryption process
struct aes{
...
//Core encrypting and decrypting functions
...
//Helper functions to create and free aes structs
...
//AddRoundKey function is its own inverse since XOR is its own inverse
static void addRoundKey(unsigned char* state, unsigned char* roundKey);

//Encryption subfunctions
...
//Lookup tables for the substitution steps, the matrix multiplications, and the keyexpansion
...
static const unsigned char i_s_box[256] = {
...
static const unsigned char mat_mul_2[256] = {
...
static const unsigned char mat_mul_3[256] = {
...
static const unsigned char mat_mul_9[256] = {
...
static const unsigned char mat_mul_11[256] = {
...
static const unsigned char mat_mul_13[256] = {
...
static const unsigned char mat_mul_14[256] = {
